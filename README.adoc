...
----
structurizrc4::workspace.dsl[renderer="plantuml-c4",viewKey="0501-System_Context_Diagram"]
----

[source,asciidoc]
.C4-PlantUML renderer with Smetana layouting
----
structurizrc4::workspace.dsl[renderer="plantuml-c4",plantumlLayoutEngine="smetana",viewKey="0501-System_Context_Diagram"]
----

[source,asciidoc]
.C4-PlantUML renderer with ELK layouting
----
structurizrc4::workspace.dsl[renderer="plantuml-c4",plantumlLayoutEngine="elk",viewKey="0501-System_Context_Diagram"]
----
...
----
.A custom title
structurizrc4::workspace.dsl[renderer="structurizr",diagramKey="0501-System_Context_Diagram"]
----
...
<plugin>
    ...
    <dependencies>
        <dependency>
            <groupId>io.github.stephanpirnbaum</groupId>
