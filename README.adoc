...
Additionally, it is possible to specify width and height of the resulting image. As the resulting diagram is embedded using the native `image::` macro, all the same rules and variants apply here:

[source,asciidoc]
.Specifying width and height
----
structurizrc4::workspace.dsl[renderer="structurizr",viewKey="0501-System_Context_Diagram",width=300,height=300]
----
